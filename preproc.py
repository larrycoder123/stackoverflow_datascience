...
# Adapted function based on langid.py/README.rst for Probablity Normalization
# Regular langid.classify(input_string) returns an unnormalized probability e.g. -35.41771221160889
# langid.py provide a re-normalization that produces an output in the 0-1 range via probablity normalization
# This is achieved either with -n or an instance of LanguageIdentifier (our case)
...
def check_lang(data_str):
    ...
    #raise Exception("predict_lang=" + str(predict_lang[1]))
    if predict_lang[1] >= .9:
